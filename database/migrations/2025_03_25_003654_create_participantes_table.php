...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('participantes', function (Blueprint $table) {
            ...
            $table->boolean('copia_papa')->default(false);
            $table->boolean('copia_mama')->default(false);
            $table->date('fecha_ficha')->nullable()->default(null);
            $table->date('fecha_acuerdo')->nullable()->default(null);
            $table->date('fecha_copia_papa')->nullable()->default(null);
            $table->date('fecha_copia_mama')->nullable()->default(null);
